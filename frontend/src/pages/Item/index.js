...
export const Item = () => {
  ...
  const __fetchTags = () => {
    try {
      dispatch(retrieve_tag())
        .then((response) => {
          setTagsData(
            response.data.map((tag) => ({ label: tag.tags, value: tag.tags }))
          );
        })
        .catch((error) => {
    ...
    if (e.target.name === "item_catogory") {
      setFormFields((prevState) => {
        if (prevState.item_catogory.includes(e.target.value)) {
          return {
            ...prevState,
            item_catogory: prevState.item_catogory.filter(
          ...
          return {
            ...prevState,
            item_catogory: [...prevState.item_catogory, e.target.value],
          };
        }
      });
    }
    if (e.target.name === "item_tags") {
      setFormFields((prevState) => {
        if (prevState.item_tags.includes(e.target.value)) {
          return {
            ...prevState,
            item_tags: prevState.item_tags.filter(
          ...
          return {
            ...prevState,
            item_tags: [...prevState.item_tags, e.target.value],
          };
        }
      });
    } else {
  ...
  const __handleSubmit = (e) => {
    ...
    formData.append(
      "offer_price",
      parseFloat(formFields.offer_price).toFixed(2)
    );
    ...
    formData.append(
      "instock_outstock_indication",
      formFields.instock_outstock_indication
    );
                  ...
                  <Form>
                    <Row>
                      ...
                      <Col md={6}>
                        <Form.Group className="mb-3">
                          ...
                          <Form.Control
                            ...
                            name="item_name"
                            onChange={(e) => __changeInputFields(e)}
                        ...
                        <Form.Group className="mb-3">
                          ...
                          <Select
                            ...
                            onChange={(selected) =>
                              setFormFields({
                                ...formFields,
                                item_catogory: selected.map((x) => x.value),
                              })
                            }
                            value={formFields.item_catogory.map((item) => ({
                              label: item,
                              value: item,
                            }))}
                          />
                        ...
                        <Form.Group className="mb-3">
                          ...
                          <Select
                            ...
                            onChange={(selected) =>
                              setFormFields({
                                ...formFields,
                                item_tags: selected.map((x) => x.value),
                              })
                            }
                            value={formFields.item_tags.map((item) => ({
                              label: item,
                              value: item,
                            }))}
                          />
                      ...
                      <Col md={6}>
                        <Form.Group className="mb-3">
                          <Form.Label className="text-white fw-semibold">
                            Instock/outstock indication
                          </Form.Label>
                          <select
                            value={formFields.instock_outstock_indication}
                            name="instock_outstock_indication"
                      ...
                      <Col md={6}>
                        <Form.Group className="mb-3">
                          ...
                          <Form.Control
                            ...
                            onChange={(e) => __changeImage(e)}
                            className="fw-semibold"
                          />
                          {formFields.item_image === "" ? (
                            <img
                              src={noIMg}
                      ...
                      <Col md={12}>
                        <Form.Group className="mb-3">
                          ...
                          <Form.Control
                            ...
                            onChange={(e) => __changeInputFields(e)}
                            value={formFields.item_discription}
                            className="fw-semibold"
                          />
                        </Form.Group>
                      </Col>
